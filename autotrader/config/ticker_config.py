...
Usage
-----
    from autotrader.config.ticker_config import load_ticker_params, save_ticker_params
...
PARAMS_FILE = Path(__file__).resolve().parent.parent.parent / "data" / "ticker_params.json"
